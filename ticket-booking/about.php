        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav nav ml-auto">
                    ...
                    <li class="nav-item"><a href="about.php" class="nav-link active"><span>About</span></a></li>
...
<section id="home-section" class="hero">
    ...
    <div class="home-slider owl-carousel mb-5">
...
<section class="ftco-counter img ftco-section ftco-no-pt ftco-no-pb my-5" id="about-section">
    <div class="container">
    <div class="row justify-content-center pb-5">
            <div class="col-md-12 heading-section text-center ftco-animate">
                <span class="subheading" style="font-size:30px;">About Us</span>
                <!-- <h2 class="mb-4 head">About Us</h2> -->
            </div>
        </div>
